...
// {
//     let x = [2,5,6,9,10]
//     let y = x[Math.floor(Math.random()*5)];
//     console.log(y);
// }
...
//         },
//         {
//           question: "How many wheels does the motorbike have?",
//           answers: {
//             a: 1,
//             b: 2,
//             c: 3,
...
//         }
//     ];
//       delete x[0].correctAnswer;
//       delete x[1].correctAnswer;
//       delete x[2].correctAnswer;
...
//   ];
  //   console.log(jobdata);
  //   console.log(job1);
  //   console.log(jobdata[0].jobTitle);
  ...
  //     console.log("benefit: ");
  //     for (let j = 0; j < jobdata[i].benefits.length; j++) {
  ...
  //     console.log("Salary: " + jobdata[i].jobSalary);
  ...
  //     }
  //     console.log("Skill:");
  //     for (let x = 0; x < jobdata[i].skills.length; x++) {
  //       console.log("- " + jobdata[i].skills[x]);
  //     }
  //   }
// }
